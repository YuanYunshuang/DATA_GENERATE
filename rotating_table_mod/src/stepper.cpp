...
void stepper ::setVelocity(float TargetVelocity)
{
    if(TargetVelocity<0)
    {
...
void stepper::setVelocityWithRamp(float TargetVelocity)
{
...
void stepper::setVelocityWithRampThreaded(float TargetVelocity)
{
...
void stepper::setPositionThreaded(float TargetPosition)
{
...
void stepper::getPosition(float &CurrentPosition)
{
...
void stepper::getVelocity(float &CurrentVelocity)
{
    float currentDelay;
    m_DelayMutex.lock();
...
void stepper::startLoop()
{
    ControlThread= boost::thread(&stepper::LoopThreaded,this);
}

void stepper::LoopThreaded()
{
    while(1)
    {
        if(m_nStep==1)
